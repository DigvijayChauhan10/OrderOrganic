...
<body>
    <header>
        ...
        <ul class="nav">
            ...
            <button class="login"><a href="http://localhost/OrderOrganic/profile.php">Profile</a></button>
            <button class="login"><a href="http://localhost/OrderOrganic/logout.php">LogOut</a></button>
        </ul>
    </header>
